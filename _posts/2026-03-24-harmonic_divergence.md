---
title: "[DRAFT] A probabilistic proof of the divergence of the harmonic series"
---
...
To do so, let $X_1,X_2,\ldots$ be a sequence of i.i.d. random variables uniformly distributed on the unit interval, and denote by $R$ the (random) set of *record times*, namely:
